	...
	client.on('chat-update', async (mek) => {
		try {
			...
			switch(command) {
				...
				case 'dono':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://imgur.com/a/jIXxZqp`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '*CRIADOR:* Leathy\n*IFUNNY:* https://ifunny.co/user/Leathyn*WPP:* wa.me/+5516996344413\n*TWITTER:* um dia eu crio kk\n\n\n*Digite *.bot* para ver comandos basicos para criar um bot'})
					break
				case 'belle2':
					memein = await kagApi.memeindo()
				...
				case 'bot':
			     	memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://imgur.com/a/Dtkk9zv`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '*_《Comandos basicos para bot:》_*\n\n*pkg upgrade && pkg update*\n*pkg install git*\n*git clone (link da git)*\n*cd (repositório)*\n*bash install.sh*\n*npm start*\n\n*Leathy ajudas, lembrando use o termux*'})
					break
				case 'belle3':
					memein = await kagApi.memeindo()
				...
				case 'ifunny':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '️*perfil do leathy:*\n\n https://ifunny.co/user/Leathy'})
					break
				case 'mia1':
					memein = await kagApi.memeindo()
